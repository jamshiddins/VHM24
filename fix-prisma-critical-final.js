...
console.log('🔧 CRITICAL Fix for Prisma Schema...');
...
console.log('📝 Fixing multiple @id issues...');
...
if (movementTypeCount > 1) {
    console.log('📝 Removing duplicate MovementType enum...');
...
console.log('🎉 All critical Prisma issues fixed!');
