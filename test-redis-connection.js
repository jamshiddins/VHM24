...
async function testRedisConnection() {
  ...
  try {
    ...
    logger.info('✅ Проверка селективного удаления:', stats ? 'stats сохранен' : 'stats удален');
    ...
    logger.info(`✅ Функция cache() работает корректно (вызовов функции: ${callCount})`);
    ...
    logger.info(`✅ Производительность: запись ${writeTime}ms, чтение ${readTime}ms`);
