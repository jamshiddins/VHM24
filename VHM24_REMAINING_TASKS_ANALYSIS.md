...
-GET / recipes - POST / recipes - GET / ingredients - POST / cost - calculation;
```
...
-recipes / page.tsx - drivers / page.tsx - warehouse / page.tsx - technicians / page.tsx;
```
...
Система уже имеет прочную основу и архитектуру. Оставшиеся задачи - это в основном доработка деталей
и интеграция уже созданных компонентов.
