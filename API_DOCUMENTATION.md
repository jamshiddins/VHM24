...
Данная документация описывает API endpoints, доступные для мобильного приложения VHM24. API построено на принципах REST и использует JSON для передачи данных.
