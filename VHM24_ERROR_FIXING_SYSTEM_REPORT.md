# VHM24 - Отчет о системе исправления ошибок
...
Система исправления ошибок может быть развернута в других проектах. Для этого используйте скрипт `deploy-error-fixing-system.js`, который создаст архив со всеми необходимыми файлами.
...
Система может быть легко адаптирована для использования в других проектах, а также расширена для выявления и исправления дополнительных типов проблем.
